    ...
    const message = (
      <>
        ...
        <div className="message message-box" data-mine={isMine}>
          {isMine && <span className="message-status">{message_object.sending ? "..." : message_object.notSend ? <ExclamationIcon /> : message_object.seen ? <DoubleTickIcon height="18px" width="18px" /> : <SentIcon height="18px" width="18px" />}</span>}
